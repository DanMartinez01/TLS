  ...
  return (
    <>
      <form
        ...
        onChange={handleOnChange}
        onSubmit={handleOnSubmit}
        className="w-full p-4 lg:w-2/4 md:w-2/4 bg-yellow rounded-md lg:shadow-lg xl:shadow-lg text-center mx-auto"
      >
        <div className="my-6 text-black-600 flex flex-col items-start">
          <input
            type="file"
          ...
          <div className="flex mb-2">
            <input
              ...
              className="w-1/4 block border border-gray-300 focus:border-2 focus:border-green-500 py-3 px-2 mr-2 rounded-md text-black-500"
              value={areaCode}
            ...
            <input
              ...
              className="w-3/4 block border border-gray-300 focus:border-2 focus:border-green-500 py-3 px-2 rounded-md text-black-500"
              required
            />
          </div>
          <label
          ...
          <textarea
            ...
            id="more_details"
            placeholder={t("formMsg")}
            className="w-full text-xs block border border-gray-300 focus:border-2 focus:border-green-500 py-4 px-2 rounded-md mb-2 text-black-500"
          ></textarea>
          <label htmlFor="language" className="mb-1">
            Translate to<span className="text-red-500"></span>/Traducir a*
          </label>
